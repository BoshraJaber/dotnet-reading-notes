...
* Example, when you enter a news website, all visitor see the same news and when there is an update, all of them see it, same goes for memory where the news website address is the 
